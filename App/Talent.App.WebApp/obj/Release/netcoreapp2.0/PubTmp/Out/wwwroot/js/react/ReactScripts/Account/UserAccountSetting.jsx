...
export default class UserAccountSetting extends React.Component {
    ...
    save(e, field) {
        ...
        if (field == "name") {            
            $.ajax({
                url: 'https://competitionweb.azurewebsites.net/identity/authentication/authentication/changeUserName?userName=' + this.state.userName,
                type: 'POST',
                headers: {
        ...
        if (field == "password") {
            ...
            $.ajax({
                url: 'https://competitionweb.azurewebsites.net/identity/authentication/authentication/changePassword',
                type: "POST",
        ...
        if (field == "deactivate") {
            $.ajax({
                url: 'https://competitionweb.azurewebsites.net/identity/authentication/authentication/deactivateAccount',
                type: "POST",
                headers: {
                    'Authorization': 'Bearer ' + cookies,
                    'Content-Type': 'application/json; charset=utf-8'
    ...
    getUserRole() {
        const cookies = Cookies.get('talentAuthToken');
        $.ajax({
            url: 'https://competitionweb.azurewebsites.net/identity/authentication/authentication/getAccountSettingInfo',
            type: 'GET',
            headers: {
                'Authorization': 'Bearer ' + cookies,
                'Content-Type': 'application/json; charset=utf-8'
