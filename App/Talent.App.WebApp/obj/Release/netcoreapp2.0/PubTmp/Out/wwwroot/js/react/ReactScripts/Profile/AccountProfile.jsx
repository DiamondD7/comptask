...
export default class AccountProfile extends React.Component {
    ...
    componentDidMount() {
        ...
        //http://localhost:60290
    loadData() {
        var cookies = Cookies.get('talentAuthToken');
        $.ajax({
            url: 'https://competitionweb.azurewebsites.net/profile/profile/profile/getTalentProfile',
            headers: {
    ...
    saveProfile() {
        var cookies = Cookies.get('talentAuthToken');
        $.ajax({
            url: 'https://competitionweb.azurewebsites.net/profile/profile/profile/updateTalentProfile',
            headers: {
                'Authorization': 'Bearer ' + cookies,
                'Content-Type': 'application/json'
            },
                                    ...
                                    <div className="ui grid">
                                        ...
                                        >
                                            <PhotoUpload
                                                ...
                                                updateProfileData={this.updateWithoutSave}
                                                savePhotoUrl='https://competitionweb.azurewebsites.net/profile/profile/profile/updateProfilePhoto'
                                            />
                                        </FormItemWrapper>
                                        <FormItemWrapper
                                            title='Profile Video'
                                        ...
                                        >
                                            <VideoUpload
                                                ...
                                                updateProfileData={this.updateWithoutSave}
                                                saveVideoUrl={'https://competitionweb.azurewebsites.net/profile/profile/profile/updateTalentVideo'}
                                            />
                                        </FormItemWrapper>
                                        <FormItemWrapper
                                            title='CV'
                                        ...
                                        >
                                            <CVUpload
                                                ...
                                                updateProfileData={this.updateWithoutSave}
                                                saveCVUrl={'https://competitionweb.azurewebsites.net/profile/profile/profile/updateTalentCV'}
                                            />
                                        </FormItemWrapper>
                                        <SelfIntroduction
