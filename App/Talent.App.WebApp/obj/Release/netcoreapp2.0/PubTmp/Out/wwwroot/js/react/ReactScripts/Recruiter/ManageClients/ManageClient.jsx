...
export default class ManageClient extends React.Component {
    ...
    // loadData url: 'https://competitionweb.azurewebsites.net/profile/profile/profile/getClientList',
    //deleteClient  url: 'https://competitionweb.azurewebsites.net/identity/authentication/authentication/deactivateClientAccount?id=' + clientId,
